angular.module('myApp').controller('loginController', ['$scope', '$location', 'AuthService',
    function($scope, $location, AuthService) {
        ...
        $scope.login = function() {
            ...
            AuthService.login($scope.loginForm.username, $scope.loginForm.password, $scope.loginForm.classes)
                // handle success
                .then(function() {
...
angular.module('myApp').controller('userController', ['$scope', '$location',
    function($scope, $location) {
        $scope.username = AuthService.getUserInformation(function(user) {
